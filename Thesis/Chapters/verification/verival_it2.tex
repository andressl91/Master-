...
\label{my-label}
\begin{tabular}{ |p{1cm}||p{1cm}|p{2.7cm}|p{2.5cm}|p{2.7cm}|p{2.7cm}|p{1.2cm}|}
 \hline
...
\label{my-label}
\begin{tabular}{ |p{0.9cm}||p{0.9cm}|p{2.7cm}|p{2.49cm}|p{2.9cm}|p{2.9cm}|}
 \hline
...
\label{my-label}
\begin{tabular}{ |p{1cm}||p{1cm}|p{2.6cm}|p{2.5cm}|p{2.7cm}|p{2.7cm}|p{1.2cm}|}
 \hline
