...
Choosing $\Delta t \in [0.2, 0.1]$ leads to $\theta = [0.7, 0.6]$, meaning the scheme is no longer centred a have \cite{Formaggia2004} explained by the structure equation influence  implicit  
