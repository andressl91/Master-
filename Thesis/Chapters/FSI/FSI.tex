...
\begin{align*}
&\hat{\sigma}_{\text{mesh}} = \alpha \hat{\nabla}\bat{u} \hspace{2mm} \text{Laplace} \\
&\hat{\sigma}_{\text{mesh}} =  \lambda Tr(\epsilon(u)) I + 2 \mu \epsilon(u) \hspace{2mm} \text{Linear Elasticity} 
\end{align*}
